...
function gaji_view_main($arg=NULL, $nama=NULL) {
	...
	$header = array (
		...
		array('data' => 'Tahun', 'width' => '50px', 'field'=> 'tahun', 'valign'=>'top'),
		array('data' => 'Bulan', 'field'=> 'bulan', 'width' => '60px', 'field'=> 'tanggal', 'valign'=>'top'),
	...
	foreach ($results as $data) {
		...
		//if (apbd_is_file_exist($file))
		$editlink = 'Buka';
		if (apbd_is_file_exist($data->gajiid, $data->kodeuk)) {
			//$editlink = apbd_button_jurnal('files/ledger_' . $data->gajiid . '/' . $data->kodeuk . '.jpg' );
			$lik='files/ledger_' . $data->gajiid . '/' . $data->kodeuk . '.jpg';
			$editlink="<a id='show' class='btn btn-success' data-link='".$lik."'>Tampilkan</a>";
		}			
		

		$rows[] = array(
					array('data' => $no, 'align' => 'right', 'valign'=>'top'),
					array('data' => $data->tahun,'align' => 'center', 'valign'=>'top'),
					array('data' => apbd_get_namabulan($data->bulan),'align' => 'center', 'valign'=>'top'),
					array('data' => $data->jenis,'align' => 'left', 'valign'=>'top'),
	...
	return drupal_render($output_form) . $output.'</br>'.$img.$img2.$script;
...
function gaji_view_main_form($form, &$form_state) {
	...
	//TAHUN
	$opt_tahun = array('2017', '2018','2019','2020','2021');
